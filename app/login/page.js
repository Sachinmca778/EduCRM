        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-2xl font-bold text-foreground">EduCRM</span>
            </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/10 via-primary/5 to-background items-center justify-center">
        <div className="max-w-lg text-center px-8">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            ...
            Track students, manage fees, and grow your institution with data-driven insights.
          </p>
          ...
          <div className="mt-8 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-foreground">Student Management & Analytics</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
              <span className="text-foreground">Automated Fee Collection</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
