      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full pl-10 pr-12 py-3 border border-input rounded-lg bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 px-4 py-3 border border-border rounded-lg hover:bg-accent transition-colors">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/10 via-primary/5 to-background items-center justify-center">
        <div className="max-w-lg text-center px-8">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            ...
            Track members, manage memberships, and grow your fitness business with data-driven insights.
          </p>
          ...
          <div className="mt-8 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-foreground">Member Management & Analytics</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
              <span className="text-foreground">Membership & Payment Tracking</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
              <span className="text-foreground">Trainer & Staff Management</span>
            </div>
          </div>
        </div>
      </div>
