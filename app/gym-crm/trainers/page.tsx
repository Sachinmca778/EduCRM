    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-2 text-gray-600">Manage gym trainers, their schedules, and assigned members</p>
        </div>
        <Link
          ...
          <div key={trainer.id} className="bg-white rounded-lg shadow overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">{trainer.schedule}</p>
              </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <button className="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-gray-300 hover:shadow-sm transition-all">
            ...
            <span className="text-sm font-medium text-gray-900">View Schedules</span>
            <span className="text-xs text-gray-500">All trainers</span>
          </button>
          
          <button className="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-gray-300 hover:shadow-sm transition-all">
            <Users className="h-8 w-8 text-green-500 mb-2" />
            <span className="text-sm font-medium text-gray-900">Assign Members</span>
            <span className="text-xs text-gray-500">To trainers</span>
          </button>
          
          <button className="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-gray-300 hover:shadow-sm transition-all">
            <Star className="h-8 w-8 text-yellow-500 mb-2" />
            <span className="text-sm font-medium text-gray-900">Performance Review</span>
            <span className="text-xs text-gray-500">Trainer ratings</span>
          </button>
          
          <button className="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-gray-300 hover:shadow-sm transition-all">
            <Dumbbell className="h-8 w-8 text-purple-500 mb-2" />
            <span className="text-sm font-medium text-gray-900">Training Programs</span>
            <span className="text-xs text-gray-500">Create & assign</span>
          </button>
        </div>
      </div>
    </div>
